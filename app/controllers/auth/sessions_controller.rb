...
class SessionsController < ApplicationController
  ...
  post '/login' do
    ...
    flash :success, "You have successfully logged in as \
          <a href='/u/#{current_user.username}' class='alert-link'>#{current_user.username}</a>"
    ...
    # flash :success, "You have successfully logged in as\
    #        <a href='/u/#{user.username}' class='alert-link'>#{user.username}</a>"
    # redirect "/projects"
    # else
  ...
  def send_email_to(user)
    body = "Hey there! Here's your login link. You can only update your password once using this \
